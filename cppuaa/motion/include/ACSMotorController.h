...
class ACSMotorController : public IMotorController {
private:
  ...
  void simulate_command_delay();

public:
  ACSMotorController();
  ~ACSMotorController() override;
  ...
  std::string get_controller_type() const override { return "ACS"; }
